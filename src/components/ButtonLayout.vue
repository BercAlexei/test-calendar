<template>
  ...
  >
    <svg
      ...
      class="icon"
      :class="{
        icon_left: optionIcon.direction === 'left',
        icon_small: optionIcon.size === 'small',
      }"
      viewBox="0 0 12 16"
      fill="none"
